...
//overloaded constructor
 Employee(double inputSalary, double inputPension, double inputMedAid, double inputTax);
...
//mutator functions
    void setSalary(double inputSalary, Employee employee);
    void setPension(double inputPension, Employee employee);
    void setMedAid(double inputMedAid, Employee employee);
    void setAllowance(double inputAllowance, Employee employee);
    void setTax(float inputTax, Employee employee);
